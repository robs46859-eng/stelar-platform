...
This quickstart gets a local FullStack AiSquad checkout running, confirms profile auto-detection, starts a tmux-backed Hermes Agent, dispatches a first task, and shows where to review the result.
...
```bash
git clone https://github.com/outsourc-e/fullstack-aisquad.git
