# Memory pointer — family-android-integrator

This file is a pointer, not a memory store.

Durable long-term memory for family-android-integrator lives at:
~/.hermes/profiles/family-android-integrator/MEMORY.md
