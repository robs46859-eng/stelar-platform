...
def main(
    ...
    api_key: str = "sk-ollama-local-dummy",
    ...
    Args:
        ...
        model (str): Model name to use (OpenRouter format: provider/model). Defaults to gemma4:26b.
        api_key (str): API key for authentication. Defaults to sk-ollama-local-dummy for local Ollama.
        base_url (str): Base URL for the model API. Defaults to http://localhost:11434/v1
