...
def populated_db(db):
    ...
    db.create_session(
        ...
        model="gemma4:26b-20250514", user_id="user1",
    )
    ...
    db.create_session(
        ...
        model="gemma4:26b-20250514", user_id="user2",
    )
...
class TestHasKnownPricing:
    def test_known_commercial_model(self):
        ...
        assert _has_known_pricing("gemma4:26b-20250514") is True
...
class TestEdgeCases:
    ...
    def test_mixed_commercial_and_custom_models(self, db):
        ...
        db.create_session(session_id="s1", source="cli", model="gemma4:26b-20250514")
