...
class TestGetModelContextLength:
    ...
    def test_fallback_to_defaults(self, mock_fetch):
        mock_fetch.return_value = {}
        assert get_model_context_length("gemma4:26b") == 200000
...
class TestStripProviderPrefix:
    def test_known_provider_prefix_is_stripped(self):
        ...
        assert _strip_provider_prefix("openrouter:gemma4:26b") == "gemma4:26b"
    ...
    def test_no_colon_returns_unchanged(self):
        ...
        assert _strip_provider_prefix("gemma4:26b") == "gemma4:26b"
...
class TestContextLengthCache:
    ...
    def test_same_model_different_providers(self, tmp_path):
        ...
        with patch("agent.model_metadata._get_context_cache_path", return_value=cache_file):
            ...
            save_context_length("llama-3", "http://localhost:11434/v1", 131072)
            assert get_cached_context_length("llama-3", "http://local:8080") == 32768
            assert get_cached_context_length("llama-3", "http://localhost:11434/v1") == 131072
