...
class TestAgentConfigSignature:
    ...
    def test_same_config_same_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "http://localhost:11434/v1",
    ...
    def test_provider_change_different_signature(self):
        ...
        rt1 = {"api_key": "sk-test12345678", "base_url": "http://localhost:11434/v1", "provider": "openrouter"}
    ...
    def test_toolset_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "http://localhost:11434/v1", "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["hermes-telegram"], "")
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        runtime = {"api_key": "test", "base_url": "http://localhost:11434/v1",
                    "provider": "openrouter", "api_mode": "chat_completions"}
        sig = runner._agent_config_signature("gemma4:26b", runtime, ["hermes-telegram"], "")

        # First message — create and cache
        agent1 = AIAgent(
            model="gemma4:26b", api_key="test",
            base_url="http://localhost:11434/v1", provider="openrouter",
    ...
    def test_cache_miss_on_model_change(self):
        ...
        old_sig = runner._agent_config_signature("gemma4:26b", runtime, ["hermes-telegram"], "")
        agent1 = AIAgent(
            model="gemma4:26b", api_key="test",
            base_url="http://localhost:11434/v1", provider="openrouter",
            max_iterations=5, quiet_mode=True, skip_context_files=True,
