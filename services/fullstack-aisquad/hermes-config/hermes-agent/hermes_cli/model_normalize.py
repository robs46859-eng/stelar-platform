...
- **Aggregators** (OpenRouter, Nous, AI Gateway, Kilo Code) need
  ``vendor/model`` slugs like ``gemma4:26b``.
...
def _strip_vendor_prefix(model_name: str) -> str:
    ...
    Examples::
        ...
        >>> _strip_vendor_prefix("gemma4:26b")
        'claude-sonnet-4.6'
...
def normalize_model_for_provider(model_input: str, target_provider: str) -> str:
    ...
    Args:
        model_input: The model name as provided by the user or config.
            ...
            (``"gemma4:26b"``), or already in native
    ...
    Examples::
        ...
        >>> normalize_model_for_provider("gemma4:26b", "anthropic")
        'claude-sonnet-4-6'

        >>> normalize_model_for_provider("gemma4:26b", "copilot")
        'claude-sonnet-4.6'
