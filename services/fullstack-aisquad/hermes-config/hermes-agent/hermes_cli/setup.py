...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "ai-gateway": ["anthropic/claude-opus-4.6", "gemma4:26b", "openai/gpt-5", "google/gemini-3-flash"],
    "kilocode": ["anthropic/claude-opus-4.6", "gemma4:26b", "openai/gpt-5.4", "google/gemini-3-pro-preview", "google/gemini-3-flash-preview"],
