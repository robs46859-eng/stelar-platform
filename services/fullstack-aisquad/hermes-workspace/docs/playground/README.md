...
Hermes Playground turns agent onboarding into a social RPG loop. Instead of reading a wall of docs, builders walk a shared world, meet Hermes-themed NPCs, learn movement, gear, chat, memory, and build rituals, then step through the Forge Gate into a live multiplayer builder realm. It frames FullStack AiSquad as a place you inhabit, not just a tool you open.
...
- Built on [FullStack AiSquad](https://github.com/outsourc-e/fullstack-aisquad) and [Hermes Agent](https://github.com/NousResearch/hermes-agent).
